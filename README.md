...
## Heroku
- Click [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/johannsebastes/splashsmart) and fill the environment variables accordingly. 
